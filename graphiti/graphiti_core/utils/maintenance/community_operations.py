...
async def build_community(
    ...
    while length > 1:
        ...
        new_summaries: list[str] = list(
            await semaphore_gather(
                *[
                    summarize_pair(llm_client, (str(left_summary), str(right_summary)), prompt_library)
...
async def update_community(
    ...
    new_summary = await summarize_pair(llm_client, (entity.summary, community.summary), prompt_library)
