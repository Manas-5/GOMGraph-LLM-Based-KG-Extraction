...
def summarize_context(context: dict[str, Any]) -> list[Message]:
    ...
    return [
        ...
        Message(
            role='user',
            content=f"""
        Given the TEXT and the ENTITY name, create a summary for the ENTITY. Your summary must only use
        information from the provided TEXT. Your summary should also only contain information relevant to the
        provided ENTITY.
