...
def node(context: dict[str, Any]) -> list[Message]:
    return [
        ...
        Given the above EXISTING ENTITIES and their attributes, CURRENT TEXT, and PREVIOUS TEXT; Determine if the NEW ENTITY extracted from the text
...
def nodes(context: dict[str, Any]) -> list[Message]:
    return [
        Message(
            role='system',
            content='You are a helpful assistant that determines whether or not ENTITIES extracted from text are duplicates'
        ...
        Each of the following ENTITIES were extracted from the CURRENT TEXT.
