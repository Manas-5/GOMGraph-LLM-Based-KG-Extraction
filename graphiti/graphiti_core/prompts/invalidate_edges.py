        ...
        Message(
            ...
            content=f"""
               ...
               Use the start and end dates of the edges to determine which edges are to be marked expired.
                ...
                Do not invalidate relationships merely because they weren't mentioned in the text. You may use the current text and previous text as well as the facts of each edge to understand the context of the relationships.
