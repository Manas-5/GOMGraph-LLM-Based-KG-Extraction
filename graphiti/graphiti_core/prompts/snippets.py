...
summary_instructions = """Guidelines:
        ...
        2. Only use the provided text, entity, and entity context to set attribute values.
        ...
        BAD: "Based on the text provided, the user attended a meeting. This summary focuses on that event as it was the main topic discussed."
