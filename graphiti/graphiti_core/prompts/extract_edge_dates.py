...
def v1(context: dict[str, Any]) -> list[Message]:
    return [
        ...
        Message(
            ...
            Task:
            Analyze the text and determine if there are dates that are part of the edge fact. Only set dates if they explicitly relate to the formation or alteration of the relationship itself.
